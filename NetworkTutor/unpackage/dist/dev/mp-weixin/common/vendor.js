...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__A780016",
    appName: "NetworkTutor",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "26.226.184.61,192.168.140.1,192.168.186.1,10.61.156.202,127.0.0.1,172.23.0.1";
  const port = "8090";
  const id = "mp-weixin__KNVRN";
